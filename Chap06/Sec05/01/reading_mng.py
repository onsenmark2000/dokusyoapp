...
class SubWindow:
    ...
    def set_widget(self):
        ...
        btn_clear_purchase.config(command=self.clear_entry(self.date_purchase))
        ...
        btn_clear_start.config(command=self.clear_entry(self.date_start))
        ...
        btn_clear_end.config(command=self.clear_entry(self.date_end))
